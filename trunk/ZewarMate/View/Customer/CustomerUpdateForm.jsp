...
<html:form action="/Customer/UpdateProfile.do" method="post">
 <html:hidden property="hasFormInitialized" />
 <html:hidden property="customerId" />
 <html:hidden property="ledgerAccountId" />
 <div>
	<span class="FORM_TITLE_LEFT">&nbsp</span><span class="FORM_TITLE_MIDDLE" style="width:250;"> Update Customer </span><span class="FORM_TITLE_RIGHT" style="text-align:right;width:360;">&nbsp;</span>
 </div>
		...
		<table border="0" class="FORM_AREA" cellpadding="0" cellspacing="1" width="800">
			...
			<tr>
				...
				<td class="FORM_CONTROL">
					...
					<br>
					City<br>
					<html:text property="cityName" size="25" maxlength="50"/>
					<br>
					Country <br>
					<html:select property="countryId">
				        <html:options collection="lookupCountry" property="id" labelProperty="label"/>
			    </html:select>
				</td>
			<tr>
			<tr>
			...
			<tr>
				...
				<td class="FORM_CONTROL">
					<html:text property="mobile" size="25" maxlength="20"/><br>
				</td>
			<tr>
			<tr>
			...
			<tr>
				...
				<td class="FORM_CONTROL">
					<html:textarea property="comments" cols="50" rows="4"/>
				</td>
			<tr>
		</table>
