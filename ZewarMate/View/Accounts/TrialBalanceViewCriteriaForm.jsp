...
<form action="../View/Accounts/TrialBalanceViewResult.jsp" method="get" target="_blank">
<div><span class="FORM_TITLE_LEFT">&nbsp;</span><span class="FORM_TITLE_MIDDLE">Trial Balance View </span><span class="FORM_TITLE_RIGHT">&nbsp;</span></div>
		...
		<tr>
			...
			<td class="FORM_CONTROL" width="450">
				<div>
				  ...
				  <input type="text"   name="year"  size="12" maxlength="4" />
				</div>
			</td>			
		</tr>
	    <tr>
