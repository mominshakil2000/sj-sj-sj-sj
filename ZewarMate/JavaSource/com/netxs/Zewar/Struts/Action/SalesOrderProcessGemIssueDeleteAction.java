...
public class SalesOrderProcessGemIssueDeleteAction extends Action {
	...
	public ActionForward execute( ActionMapping mapping
		...
		try {
				...
				// Process Items
				stmt.executeUpdate("DELETE FROM sales_order_process_gem_issue WHERE  SALES_ORDER_PROCESS_GEM_ISSUE_ID='"+request.getParameter("salesOrderProcessGemIssueReturnId")+"'");
				stmt.close();
				connection.close();
			} catch(Exception e) {
