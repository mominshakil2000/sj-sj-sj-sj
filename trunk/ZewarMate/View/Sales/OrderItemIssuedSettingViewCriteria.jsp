...
%>
<form action="../View/Sales/OrderItemIssuedSettingViewResult.jsp" method="post" target="_blank">
<div><span class="FORM_TITLE_LEFT">&nbsp;</span><span class="FORM_TITLE_MIDDLE" style="width:300px;">Order Item Issued For Setting Report </span><span class="FORM_TITLE_RIGHT">&nbsp;</span></div>
