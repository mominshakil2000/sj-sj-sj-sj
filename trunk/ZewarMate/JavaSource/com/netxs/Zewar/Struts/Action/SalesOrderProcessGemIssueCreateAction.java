...
public class SalesOrderProcessGemIssueCreateAction extends Action {
	...
	public ActionForward execute( ActionMapping mapping
		...
		try {
				...
				String query = 	"INSERT INTO sales_order_process_gem_issue ( TRANSACTION_DATE, SALES_ORDER_PROCESS_ID , ITEM_ID , WEIGHT , WEIGHT_UNIT_ID , QUANTITY, ITEM_STOCK_TYPE ) " 
					+ " VALUES ( " 
