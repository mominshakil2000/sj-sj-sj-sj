...
<html:form action="/Inventory/UpdateVendorStockVoucher.do" method="post" styleId="myForm" onsubmit="updateFormObjects();">
 ...
 <div>
	<span class="FORM_TITLE_LEFT">&nbsp</span><span class="FORM_TITLE_MIDDLE" style="width:350;">Update Stock Issue/Return Voucher</span><span class="FORM_TITLE_RIGHT" style="text-align:right;width:260;">&nbsp;</span>
 </div>
...
<!--
	...
	function GetFormDataFromServer() {
		...
		var url="XmlVendorStockVoucher.do?&cache=0&voucherPrefix="+oGForm.voucherPrefix.value+"&voucherPostfix="+oGForm.voucherPostfix.value;
...
//			alert(oGXmlHttp.responseText);
			...
			if (vControlFlag[0]) {
				if (vControlFlag[0].getElementsByTagName("ResponseFlag")[0].text=="0")  {
					...
					oGClassVoucher.inventoryVendorStockVoucherId = oLXmlVoucher[0].getElementsByTagName("InventoryVendorStockVoucherId")[0].text;
					...
					if (oGClassVoucher.voucherPrefix == "VI") {
						oGClassVoucher.inventoryAccountIdVendor = oLXmlVoucher[0].getElementsByTagName("InventoryAccountIdIn")[0].text;
						oGClassVoucher.inventoryAccountIdCompany = oLXmlVoucher[0].getElementsByTagName("InventoryAccountIdOut")[0].text;						
					} else if (oGClassVoucher.voucherPrefix == "VR") {
						oGClassVoucher.inventoryAccountIdVendor = oLXmlVoucher[0].getElementsByTagName("InventoryAccountIdOut")[0].text;
						oGClassVoucher.inventoryAccountIdCompany = oLXmlVoucher[0].getElementsByTagName("InventoryAccountIdIn")[0].text;
					} else { 
						alert ("Unknown voucher type.");
						oGClassVoucher = new ClassVoucher();
						return;
					}
					...
					oGClassVoucher.oGListClassVoucherItemMetal.length = 0;
					oLXmlVoucherItemMetal = oLXmlVoucher[0].getElementsByTagName("VoucherItemMetal");
					for(var i=0; i < oLXmlVoucherItemMetal.length; i++) {
						oClassVoucherItemMetal = new ClassVoucherItemMetal();
						oClassVoucherItemMetal.insertable = oLXmlVoucherItemMetal[i].getElementsByTagName("Insertable")[0].text;
						oClassVoucherItemMetal.inventoryVendorStockVoucherItemId = oLXmlVoucherItemMetal[i].getElementsByTagName("InventoryVendorStockVoucherItemId")[0].text;
						oClassVoucherItemMetal.inventoryMetalEntryIdIn = oLXmlVoucherItemMetal[i].getElementsByTagName("InventoryMetalEntryIdIn")[0].text;
						oClassVoucherItemMetal.inventoryMetalEntryIdOut = oLXmlVoucherItemMetal[i].getElementsByTagName("InventoryMetalEntryIdOut")[0].text;
						oClassVoucherItemMetal.issueItemId = oLXmlVoucherItemMetal[i].getElementsByTagName("IssueItemId")[0].text;
						oClassVoucherItemMetal.actualItemId = oLXmlVoucherItemMetal[i].getElementsByTagName("ActualItemId")[0].text;
						oClassVoucherItemMetal.issueWeight = oLXmlVoucherItemMetal[i].getElementsByTagName("IssueWeight")[0].text;
						oClassVoucherItemMetal.alloyRate = oLXmlVoucherItemMetal[i].getElementsByTagName("AlloyRate")[0].text;
						oClassVoucherItemMetal.alloyWastageUnitId = oLXmlVoucherItemMetal[i].getElementsByTagName("AlloyWastageUnitId")[0].text;
						oClassVoucherItemMetal.actualWeight = oLXmlVoucherItemMetal[i].getElementsByTagName("ActualWeight")[0].text;
						oClassVoucherItemMetal.comments = oLXmlVoucherItemMetal[i].getElementsByTagName("Comments")[0].text;
						oGClassVoucher.oGListClassVoucherItemMetal[i] = oClassVoucherItemMetal;
					}
					loadFormData();
				} else {
...
//		oGForm.buttonUnloadVoucher.disabled = false;
	...
	function unloadFormData() {
		...
		oGForm.inventoryVendorStockVoucherId.value = "";
		oGForm.inventoryAccountIdVendor.value = "";
		oGForm.entryDate.readOnly = false; 
		oGForm.entryDate.value = "";
		oGForm.entryDate.readOnly = true;
		
		//unload voucher entries
		var oLRows = oGTableVoucherItemMetal.getElementsByTagName("tbody").item(0).rows;
		var vLRows = oLRows.length;

		for(; vLRows > 0; vLRows--) {
			removeItemOnVoucherItemMetal(oLRows.item(vLRows-1));
