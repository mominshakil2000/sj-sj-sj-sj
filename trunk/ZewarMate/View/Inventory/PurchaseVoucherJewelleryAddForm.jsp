...
<html:form action="/Inventory/CreatePurchaseJewelleryVoucher.do" method="post" styleId="myForm" onsubmit="updateFormObjects();">
 ...
 <div>
	<span class="FORM_TITLE_LEFT">&nbsp</span><span class="FORM_TITLE_MIDDLE" style="width:250;">New Purchase Jewellery Voucher</span><span class="FORM_TITLE_RIGHT" style="text-align:right;width:360;">&nbsp;</span>
 </div>
			...
			<nested:iterate property="voucherItemList" id="voucherItem" indexId="voucherItemIndex">
				<tr>
					...
					<td class="FORM_CONTROL">
						...
						<nested:hidden name="voucherItem" indexed="true" property="inventoryPurchaseVoucherItemId" />
						<nested:hidden name="voucherItem" indexed="true" property="inventoryItemEntryIdIn" />
