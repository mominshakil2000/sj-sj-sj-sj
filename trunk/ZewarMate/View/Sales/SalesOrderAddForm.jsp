...
<html:form action="/SalesOrder/CreateOrderCart" method="post"  onsubmit="updateFormObjects();">
<div><span class="FORM_TITLE_LEFT">&nbsp;</span><span class="FORM_TITLE_MIDDLE">Sales Order Card</span><span class="FORM_TITLE_RIGHT">&nbsp;</span></div>
	<div class="BOX" style="width:995;">
		...
		<table class="FORM_AREA" width="600"  cellpadding="0" cellspacing="1">
			...
			<tr>
				...
				<td class="FORM_CONTROL">
					...
					<input type="button" name="buttonEstimatedDeliveryDate" value=" ... " onclick="return showCalendar('estimatedDeliveryDate', 'y-mm-dd');">
					<script type="text/javascript">
						var cal = new Zapatec.Calendar.setup({
		...
		<br>
		<div align="right"><html:submit property="submitAction" value="Save & Continue Later" /> <html:submit property="submitAction" value="Create Order" onclick="this.form.orderCreated.value=1;" /></div>
	</div>
