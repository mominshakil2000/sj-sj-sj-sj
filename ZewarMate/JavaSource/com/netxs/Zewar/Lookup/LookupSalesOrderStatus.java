...
public class LookupSalesOrderStatus {
	...
	public static void refreshCache() {
		...
		try {
			...
			String query = "SELECT * FROM sales_order_status ";
			ResultSet rs = stmt.executeQuery(query);

			while (rs.next()) {
				LookupDO obj = new LookupDO();
				obj.setId(rs.getInt("sales_order_status_id"));
				obj.setLabel(rs.getString("sales_order_status"));
				list.add(obj);
			}
			stmt.close();
			connection.close();
