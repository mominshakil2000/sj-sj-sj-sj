...
%>
<form action="../View/Inventory/VendorStatementViewResult.jsp" method="get" target="_blank">
<div><span class="FORM_TITLE_LEFT">&nbsp;</span><span class="FORM_TITLE_MIDDLE">Karigar Statement </span><span class="FORM_TITLE_RIGHT">&nbsp;</span></div>
