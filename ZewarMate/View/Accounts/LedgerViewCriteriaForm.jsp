...
%>
<form action="../View/Accounts/LedgerViewResult.jsp" method="get" target="_blank">
<div><span class="FORM_TITLE_LEFT">&nbsp;</span><span class="FORM_TITLE_MIDDLE">Ledger View </span><span class="FORM_TITLE_RIGHT">&nbsp;</span></div>
