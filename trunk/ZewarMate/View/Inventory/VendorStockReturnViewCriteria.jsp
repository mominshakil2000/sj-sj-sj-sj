...
%>
<form action="../View/Inventory/VendorStockReturnViewResult.jsp" method="get" target="_blank">
<div><span class="FORM_TITLE_LEFT">&nbsp;</span><span class="FORM_TITLE_MIDDLE">Vendor Stock Return View </span><span class="FORM_TITLE_RIGHT">&nbsp;</span></div>
