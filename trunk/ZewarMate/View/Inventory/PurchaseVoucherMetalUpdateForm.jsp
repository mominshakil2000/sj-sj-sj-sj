...
<html:form action="/Inventory/UpdatePurchaseMetalVoucher.do" method="post" styleId="myForm" onsubmit="updateFormObjects();">
 ...
 <div>
	<span class="FORM_TITLE_LEFT">&nbsp</span><span class="FORM_TITLE_MIDDLE" style="width:250;">Update Purchase Metal Voucher</span><span class="FORM_TITLE_RIGHT" style="text-align:right;width:360;">&nbsp;</span>
 </div>
...
/*		For Meatl Item */
		...
		oValue.value = parseFloat(oWeight.value) * parseFloat(oRate.value) ;
	}
