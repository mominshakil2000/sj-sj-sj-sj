...
<!-- Begin 
	// accountDescriptionLevel[0] = Control
	// accountDescriptionLevel[0] = Detail
	
	function showLedgerTypeElements() {
		var objForm = document.forms[0];
		if (objForm.accountDescriptionLevel[0].checked) {
...
<html:form action="/Ledger/CreateAccount" method="post">
	<html:hidden property="hasFormInitialized" />
	<div><span class="FORM_TITLE_LEFT">&nbsp</span><span class="FORM_TITLE_MIDDLE">New Account </span><span class="FORM_TITLE_RIGHT">&nbsp;</span></div>
		...
		<table border="0" class="FORM_AREA" cellpadding="0" cellspacing="1" width="900" style="height: auto;" id="tbl1">
			...
			<tr>
				...
				<td class="FORM_CONTROL">
					<html:radio property="accountDescriptionLevel" value="1" onclick="showLedgerTypeElements()" />Control
					<html:radio property="accountDescriptionLevel" value="2" onclick="showLedgerTypeElements()" />Detail 
				</td>
			</tr>
			<tr>
