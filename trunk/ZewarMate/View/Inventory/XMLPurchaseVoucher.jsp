...
<RootNote>
	...
	<% if(responseFlag==1){ %>
		<Voucher>
			<InventoryPurchaseVoucherId><%=rsVoucher.getInt("inventory_purchase_voucher_id")%></InventoryPurchaseVoucherId>
			...
			<CashVoucherId><%=rsVoucher.getString("Cash_Voucher_Id")%></CashVoucherId>
			<CashVoucherEntryId><%=rsVoucher.getString("Cash_Voucher_Entry_Id")%></CashVoucherEntryId>	
			<% while(rsVoucherItems.next()){ %>			
				<VoucherItem>
					<Insertable>false</Insertable>
					<InventoryPurchaseVoucherItemId><%=rsVoucherItems.getString("inventory_purchase_voucher_item_id")%></InventoryPurchaseVoucherItemId>
					<InventoryItemEntryIdIn><%=rsVoucherItems.getString("inventory_item_entry_id_in")%></InventoryItemEntryIdIn>
			...
			<% } %>
			<%if(rsVoucherJewelleryGem!=null){
				while(rsVoucherJewelleryGem.next()){ %>			
				<VoucherJewelleryGem>
					<Insertable>false</Insertable>
					<InventoryPurchaseVoucherJewelleryGemId><%=rsVoucherJewelleryGem.getString("inventory_purchase_voucher_jewellery_gem_id")%></InventoryPurchaseVoucherJewelleryGemId>
			...
			%>
			<%if(rsVoucherJewelleryMetal!=null) {
				while(rsVoucherJewelleryMetal.next()){ %>			
				<VoucherJewelleryMetal>
					<Insertable>false</Insertable>
					<InventoryPurchaseVoucherJewelleryMetalId><%=rsVoucherJewelleryMetal.getString("inventory_purchase_voucher_jewellery_metal_id")%></InventoryPurchaseVoucherJewelleryMetalId>
