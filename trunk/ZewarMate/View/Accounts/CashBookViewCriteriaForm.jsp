...
<% 	Connection connection;
		...
		rsCashBookAccounts = stCashBookAccounts.executeQuery (
		 ...
		 +" WHERE la.account_description_level=2 AND la.account_code_prefix like 'CA' "
		 +" ORDER BY  la.account_code_postfix"
		);		
	  String today = DateFormat.getDateInstance(DateFormat.MEDIUM,Locale.CANADA_FRENCH).format(new Date());	
%>

<form action="../View/Accounts/CashBookViewResult.jsp" method="get" target="_blank">
<div><span class="FORM_TITLE_LEFT">&nbsp;</span><span class="FORM_TITLE_MIDDLE">Cash / Bank Book </span><span class="FORM_TITLE_RIGHT">&nbsp;</span></div>
<div class="BOX" style="width:620;">
	<br>
	<table class="FORM_AREA">
		<tr>
			<td class="FORM_CAPTION">Cash Ledger Account</td>
