...
//	response.setContentType( "application/pdf" );
	response.addHeader("Content-Disposition","attachment; filename=CreditSales.pdf");
	JasperDesign jasperDesign = JRXmlLoader.load(this.getClass().getResourceAsStream("/JasperReport/CreditSalesMaster.jrxml"));
	...
	parameterMap.put("CRITERIA_LEDGER_ACCOUNT_ID",com.netxs.Zewar.CommonUtil.arrayToString(request.getParameterValues("acId"),",")); 
...
//    JasperExportManager.exportReportToPdfFile(jasperPrint, application.getRealPath("/Report/CreditSalesMaster.pdf"));
