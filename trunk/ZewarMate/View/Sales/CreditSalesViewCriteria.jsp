...
%>
<form action="../View/Sales/CreditSalesViewResult.jsp" method="post" target="_blank">
<div><span class="FORM_TITLE_LEFT">&nbsp;</span><span class="FORM_TITLE_MIDDLE">Credit Sales Report</span><span class="FORM_TITLE_RIGHT">&nbsp;</span></div>
<div class="BOX" style="width:620;">
	...
	<table class="FORM_AREA">
		...
		<tr>
			<td class="FORM_CAPTION">Customer Ledger Account</td>
			<td class="FORM_CONTROL">
				<div>
					<select name="acId" multiple="multiple" size="8">
