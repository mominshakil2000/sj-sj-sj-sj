...
<html:form action="/SalesOrder/CreateOrderReOpen" method="post"  onsubmit="updateFormObjects();">
<div><span class="FORM_TITLE_LEFT">&nbsp;</span><span class="FORM_TITLE_MIDDLE">Sales Order Card</span><span class="FORM_TITLE_RIGHT">&nbsp;</span></div>
	<div class="BOX" style="width:995;">
		...
		<br>
		<div align="right"><html:submit property="submitAction" value="Create Order" onclick="this.form.orderCreated.value=1;" /></div>
	</div>
