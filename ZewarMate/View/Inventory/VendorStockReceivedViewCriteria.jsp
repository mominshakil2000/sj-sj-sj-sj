...
%>
<form action="../View/Inventory/VendorStockReceivedViewResult.jsp" method="get" target="_blank">
<div><span class="FORM_TITLE_LEFT">&nbsp;</span><span class="FORM_TITLE_MIDDLE">Vendor Stock Received View </span><span class="FORM_TITLE_RIGHT">&nbsp;</span></div>
