...
<html:form action="/Inventory/UpdateSalesJewelleryVoucher.do" method="post" styleId="myForm" onsubmit="updateFormObjects();">
 ...
 <div>
	<span class="FORM_TITLE_LEFT">&nbsp</span><span class="FORM_TITLE_MIDDLE" style="width:250;">Update Sales Jewellery Voucher</span><span class="FORM_TITLE_RIGHT" style="text-align:right;width:360;">&nbsp;</span>
 </div>
