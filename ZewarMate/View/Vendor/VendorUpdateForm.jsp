...
<html:form action="/Vendor/UpdateVendorProfile.do" method="post">
 <html:hidden property="hasFormInitialized" />
 <html:hidden property="vendorId" />
 <html:hidden property="ledgerAccountId" />
 <div>
	<span class="FORM_TITLE_LEFT">&nbsp</span><span class="FORM_TITLE_MIDDLE" style="width:250;">Update Vendor </span><span class="FORM_TITLE_RIGHT" style="text-align:right;width:360;">&nbsp;</span>
 </div>
		 		...
		 		<div style="overflow:auto; width:360px; height:300px; padding:0px; margin:0px;border-width:1px; border-color:#736356; border-style:solid; border-collapse:collapse;">
					<table border="0" class="LIST_AREA" cellpadding="0" cellspacing="1" width="340">
						...
						<logic:iterate id="metalWastage" name="vendorForm" property="metalWastageList">
							<tr>
								<td class="LIST_DATA" >
									<html:hidden name="metalWastage" property="insertable" indexed="true" />
									<html:hidden name="metalWastage" property="itemId" indexed="true" />
									<html:hidden name="metalWastage" property="itemName" indexed="true" />
									<html:hidden name="metalWastage" property="agreedWastageUnitId" indexed="true"/>
									<bean:write name="metalWastage" property="itemName"/>
								</td>
								<td class="LIST_DATA" ><html:text name="metalWastage" property="agreedWastage" indexed="true" size="4" maxlength="5" />
								</td>
							</tr>
						</logic:iterate>
					</table>
